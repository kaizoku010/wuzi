    ...
    return (
        ...
        <footer className="footer ">
                <div className="footer__holder">
                    ...
                    <p className="footer__about">By signing-in you agree to Wuzi's Conditions of Use & Sale. Please see our Privacy Notice, Our Cookies Notice and our Interest-Based Ads Notice.</p>
